## 1. Retail Data Context and the GIGO Concept
### 1.1. Context

The modern retail industry is entering a digital era where data serves as the core element helping businesses make decisions and create competitive advantages. 
The growth of the *Omnichannel* retail model has led to continuous data generation from various sources such as *Point of Sale* (POS) systems, e-commerce, loyalty programs, and inventory management systems. 
However, the rapid increase in volume, velocity, and variety of data also raises risks regarding accuracy and consistency.

In Vietnam, the transition to omnichannel retail is happening robustly. 
Many businesses have integrated data from physical stores and online platforms to build comprehensive customer profiles and optimize operations. 
Nonetheless, *data fragmentation* between channels remains a major challenge, leading to discrepancies in demand forecasting, inventory management, and strategic planning.

### 1.2. The GIGO Concept

The concept of "*Garbage In, Garbage Out*" (GIGO) is a fundamental principle in computer science and data analysis, emphasizing that the quality of a system's output depends entirely on the quality of its input. 
No matter how complex the system or how advanced the AI algorithms are, if the input data is flawed, incomplete, or biased, the resulting output will be worthless or even harmful.

The origin of this term is deeply linked to the history of computing Charles Babbage, considered the father of the computer, once expressed surprise at the question of whether a machine could produce a right answer from wrong data. 
In 1957, William D. Mellin, a U.S. Army mathematics specialist, stated that computers cannot think for themselves and "*sloppy programming*" inputs lead to wrong results. 
By the 1960s, George Fuechsel of IBM popularized the phrase to educate users on the importance of data entry accuracy

## 2. The Role of Data Cleaning
### 2.1. Concept of Data Cleaning
*Data cleaning* refers to the process of processing data to clean raw datasets. *Cleaning* operations aim to improve the quality and usability of data consistently.

The importance of data cleaning in various fields:

1. Data Analysis:
    - Ensures accuracy in making critical decisions: The integrity of conclusions depends on data cleanliness.
    - Minimizes bias during analysis, especially in R&D, business, etc.

2. Data Science:
    - Accounts for 60-80% of the time and effort in a project.
    - Helps scientists build highly reliable models.
    - Optimizes algorithms in terms of both cost and time.

3. Machine Learning: 
    - The foundation for building effective models. 
    - Improves generalization capabilities on new data.
